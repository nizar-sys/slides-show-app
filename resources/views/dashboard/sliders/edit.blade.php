                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                        placeholder="Title Slider" value="{{ old('title', $slider->title) }}" name="title">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                                        ...
                                        @foreach ($stats as $status)
                                            <option value="{{ $status }}" @if (old('status', $slider->status) == $status) selected @endif>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror" id="order"
                                        placeholder="Order Slider" value="{{ old('order', $slider->order) }}" name="order">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    placeholder="Description Slider" name="desc" cols="30" rows="10">{{ old('desc', $slider->desc) }}</textarea>
